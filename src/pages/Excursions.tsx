...
const destinations = [
  {
    ...
    highlights: [
      ...
      'Wine tasting at <a href="https://www.enotecavanni.com/" target="_blank" rel="noopener noreferrer" style="font-weight:600;color:hsl(var(--burg));text-decoration:underline;text-decoration-color:hsl(var(--gold));text-underline-offset:3px;">Enoteca Vanni</a> — Lucca\'s most beloved wine bar',
  ...
  },
  {
    ...
    highlights: [
      'The Leaning Tower — book entry tickets in advance at <a href="https://www.opapisa.it/en" target="_blank" rel="noopener noreferrer" style="font-weight:600;color:hsl(var(--burg));text-decoration:underline;text-decoration-color:hsl(var(--gold));text-underline-offset:3px;">opapisa.it</a>',
  ...
  },
  {
    ...
    highlights: [
      ...
      '<a href="https://www.mercatocentrale.com/florence/" target="_blank" rel="noopener noreferrer" style="font-weight:600;color:hsl(var(--burg));text-decoration:underline;text-decoration-color:hsl(var(--gold));text-underline-offset:3px;">Mercato Centrale</a> for lunch',
    ],
