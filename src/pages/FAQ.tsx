...
const faqs = [
  {
    ...
    items: [
      ...
      { q: "What if one of my Save the Dates didn't arrive — and how do I know if I received a plus one?", a: "Our guest list was thoughtfully curated with our most intimate family, friends, and the significant others who have been a part of Jordan and McKenna's story. All guests formally invited to the wedding will be able to search their name upon entry into this website, and any plus one will be clearly designated on the email banner sent to them. If you believe your Save the Date may have been lost in the mail, please reach out to McKenna directly and we will happily resend it." },
