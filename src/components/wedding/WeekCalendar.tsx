...
const details: Record<number, DayDetail> = {
  19: {
    ...
    activities: [
      ...
      { title: "Sera · Evening",         note: 'Aperitivo in the Piazza dell\'Anfiteatro, then dinner at <a href="https://www.osteriadarosolo.com/" target="_blank" rel="noopener noreferrer" style="font-weight:600;color:hsl(var(--burg));text-decoration:underline;text-decoration-color:hsl(var(--gold));text-underline-offset:3px;">Osteria Da Rosolo</a>, <a href="https://www.ristorantegiglio.com/" target="_blank" rel="noopener noreferrer" style="font-weight:600;color:hsl(var(--burg));text-decoration:underline;text-decoration-color:hsl(var(--gold));text-underline-offset:3px;">Ristorante Giglio</a>, or <a href="https://www.bucadisantantonio.com/en/" target="_blank" rel="noopener noreferrer" style="font-weight:600;color:hsl(var(--burg));text-decoration:underline;text-decoration-color:hsl(var(--gold));text-underline-offset:3px;">Buca di Sant\'Antonio</a> in the heart of Lucca' },
    ],
  },
  20: {
